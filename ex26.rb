...
def sort_words(words)
    return sorted(words) # there is no need for return 
end
...
def puts_last_word(words)
    word = words.pop(-1 #correction needs a closing ) 
    puts word
end
...
#Type god should be good and there shouldnt be tabbed for things 
